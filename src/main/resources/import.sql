...
insert into hotel(hotelId, hotelName, numOfRooms, address, postcode, city, ammenities, starRating, airportTransfers, transferprice, verified) values (HOTEL_SEQ.nextval, 'Radisson Blue', 43,'123 argyle street','G3 6OP', 'Glasgow','Conference Rooms, Bars, Near Central Station', 4, false, 20, true);
...
insert into bookings(bookingId, checkInDate, checkOutDate, roomType, extras, hotel, roomPrice, extrasPrice, totalPrice) values (BOOKING_SEQ.nextval, TO_DATE('2020/04/05', 'yyyy/mm/dd'), TO_DATE('2020/04/12', 'yyyy/mm/dd'), 'STANDARD', 'AIRPORTTRANSFER', 'Travellodge Glasgow', '30.00', '20.00','230.00');
